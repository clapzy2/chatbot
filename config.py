...
КОНТЕКСТ (с указанием источника и раздела):
{context}
...
3. В конце ответа ОБЯЗАТЕЛЬНО укажи источники строго в таком формате:
**Источники:**
- Фрагмент N (Название_файла, Название_раздела): «...короткая цитата...»
...
В конце ОБЯЗАТЕЛЬНО укажи источники по шаблону:
**Источники:**
- Фрагмент N (Название_файла, Название_раздела): «...короткая цитата...»
Если не можешь найти информацию - напиши: НЕТ ИНФОРМАЦИИ.
